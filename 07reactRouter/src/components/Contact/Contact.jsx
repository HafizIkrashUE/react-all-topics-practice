          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-6 mr-2 bg-gray-100 sm:rounded-lg">
              ...
              <p className="text-lg text-gray-600 mt-2">
                Have a question, feedback, or want to collaborate on a React
                project? Feel free to reach out using the information below or
              ...
              <div className="flex items-center mt-8 text-gray-600">
                ...
                <div className="ml-4 text-md font-semibold w-64">
            ...
            <form className="p-6 flex flex-col justify-center">
              ...
              <button
                type="submit"
                className="md:w-40 mt-6 bg-orange-700 text-white font-bold py-3 px-6 rounded-lg hover:bg-orange-600 transition duration-300"
              >
                Send Message
              </button>
